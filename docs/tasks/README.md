...
- **`v2/`** — the **v2 chain**, planned but not yet written. v2 rebuilds
  the UI against a three-mode single-engine architecture (FM/SQ/D)
  modelled on Inphonik's RYM2612 and PCM2612. See ADRs 0021–0025 for the
  design decisions and `docs/design/archive/README.md` for the v1→v2
  pivot summary.
